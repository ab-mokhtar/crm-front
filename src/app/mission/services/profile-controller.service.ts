...
export class ProfileControllerService extends BaseService {
   ...
   */
  static readonly Descriptor111Path = '/profile/company';
   ...
   */
  static readonly Descriptor113Path = '/profile/facturation';
   ...
   */
  static readonly Descriptor114Path = '/profile/missions';
  ...
  descriptor114$Any(params?: {
    ...
    return this.descriptor114$Any$Response(params).pipe(
      map((r: StrictHttpResponse<string>) => r.body as string)
    );
  }
  ...
  descriptor114$Json(params?: {
    ...
    return this.descriptor114$Json$Response(params).pipe(
      map((r: StrictHttpResponse<JsonSchema>) => r.body as JsonSchema)
    );
  }
